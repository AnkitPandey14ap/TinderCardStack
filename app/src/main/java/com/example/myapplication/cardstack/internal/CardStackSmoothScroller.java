...
import com.example.myapplication.cardstack.CardStackLayoutManager;
import com.example.myapplication.cardstack.CardStackListener;
import com.example.myapplication.cardstack.RewindAnimationSetting;

import static com.example.myapplication.cardstack.internal.CardStackState.Status.AutomaticSwipeAnimating;
...
public class CardStackSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected void onStart() {
        ...
        switch (type) {
            case AutomaticSwipe:
                state.next(AutomaticSwipeAnimating);
